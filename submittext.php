...
<form action="submittext2.php" method="post">
Insert Message: <input type="text" name="text"><br>
...
Longitude (optional): <input type="text" name="mlong"><br>
Latitude (optional): <input type="text" name="mlat"><br>
